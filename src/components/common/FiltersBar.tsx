...
export const FiltersBar: React.FC<{ extraFilters?: React.ReactNode; extraFilterCount?: number; onResetExtraFilters?: () => void; visibleCount?: number }> = ({ extraFilters, extraFilterCount = 0, onResetExtraFilters, visibleCount }) => {
  ...
  const secondaryActiveCount = secondaryFilterKeys.filter(key => Boolean((filters as Record<string, unknown>)[key])).length + extraFilterCount;
